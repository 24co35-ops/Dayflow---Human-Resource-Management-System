...
function Dashboard() {
  ...
  return (
    <div className="space-y-7">
      ...
      {view === "Leave & time off" && <LeaveView role={role} leaves={sortedLeaves} updateLeave={updateLeave} onDraft={() => { setFlowOpen(true); setDraftLeave(true) }} />}
